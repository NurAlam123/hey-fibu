...
import type { InteractionObject, MessageComponentDataStructure } from "../discord/discordTypes";
...
export const selectHandler = async (res: Response, body: InteractionObject<MessageComponentDataStructure>) => {
